...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let totalPrepTime = preparationTimeInMinutes(numberOfLayers);
  let totalTimeOven = remainingMinutesInOven(actualMinutesInOven);
  return totalPrepTime + (EXPECTED_MINUTES_IN_OVEN - totalTimeOven);
}
